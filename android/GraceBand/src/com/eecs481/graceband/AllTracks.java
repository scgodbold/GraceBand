...
//		tracks.add(new Track(R.raw.guitar, "Guitar", R.drawable.selectorbeatbox_trackmenu, R.drawable.selectorbeatbox));
		...
		tracks.add(new Track(R.raw.bass_3, "Bass 3", R.drawable.selector_bass_blue, R.drawable.selector_bass_blue_remove, Category.BASS));
...
//		tracks.add(new Track(R.raw.basschord_3, "Bass Chords 3", R.drawable.selector_cord_blue, R.drawable.selector_cord_blue_remove,Category.CHORD));
		tracks.add(new Track(R.raw.harpsich_1, "Harpsichord", R.drawable.selector_cord_red, R.drawable.selector_cord_red_remove,Category.CHORD));
		tracks.add(new Track(R.raw.orch_1, "Orchestra", R.drawable.selector_cord_green, R.drawable.selector_cord_green_remove,Category.CHORD));
		...
		tracks.add(new Track(R.raw.bell_1, "Bell", R.drawable.selector_cymbal_red, R.drawable.selector_cymbal_red_remove, Category.CYMBAL));
		...
		tracks.add(new Track(R.raw.kick_3, "Kick 3", R.drawable.selector_drum_blue, R.drawable.selector_drum_blue_remove,Category.DRUM));
		...
		tracks.add(new Track(R.raw.epiano_1, "E-Piano 1", R.drawable.selector_question_orange, R.drawable.selector_question_orange_remove, Category.MISC));
		tracks.add(new Track(R.raw.epiano_2, "E-Piano 2", R.drawable.selector_question_red, R.drawable.selector_question_red_remove, Category.MISC));
		tracks.add(new Track(R.raw.zen_1, "Zen 1", R.drawable.selector_question_purple, R.drawable.selector_question_purple_remove, Category.MISC));
		tracks.add(new Track(R.raw.zen_2, "Zen 1", R.drawable.selector_question_blue, R.drawable.selector_question_blue_remove, Category.MISC));
